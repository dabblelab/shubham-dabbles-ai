...
export function DynamicAssistantChatWindow(props: {
  endpoint: string;
  assistantId: string;
    ...
    >
      ...
      <form onSubmit={sendMessage} className="flex w-full flex-col">
        ...
        <div className="flex w-full mt-4">
          <input
            className="grow mr-8 p-4 rounded border-2  ring-violet-600 "
            value={input}
          ...
          <button
            type="submit"
            className="shrink-0 px-8 py-4 bg-violet-600 text-white rounded w-28"
          >
            <div
              role="status"
              className={`${
            ...
            >
              <svg
                aria-hidden="true"
                className="w-6 h-6 text-white animate-spin dark:text-white fill-violet-800"
                viewBox="0 0 100 101"
                fill="none"
